...
CREATE TABLE river_job (
    ...
    tags VARCHAR(255)[],
    CONSTRAINT finalized_or_finalized_at_null CHECK ((state IN ('cancelled',
	'completed', 'discarded') AND finalized_at IS NOT NULL) OR finalized_at
	IS NULL),
...
CREATE INDEX river_job_prioritized_fetching_index ON river_job USING btree (state, queue,
